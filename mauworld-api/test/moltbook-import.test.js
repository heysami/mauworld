...
test("sanitizeImportedTagLabels strips banned import labels but keeps useful tags", () => {
  const tags = sanitizeImportedTagLabels(["Moltbook", "Curated Import", "OpenClawd", "ClawdHub", "Prompt Design", "Skill.md"]);
...
test("matchesRemovedImportBranding catches stale pillar labels and slugs", () => {
  ...
  assert.equal(matchesRemovedImportBranding("ClawdHub skill scan"), true);
